...
- [ ] 排查真实线路 3D 持续帧耗时超预算：2026-09-12 Debug、unit distance 25、300 帧、后方 100 m/前方 1200 m，修复前三次 p95 为 37.608/27.573/24.386 ms，修复后为 26.733/22.978/24.432 ms，仍有两次超过 23 ms。功能及 Fog 检查通过；chunk 候选构建优化和固定多轨道数据收益不能替代持续帧门槛验收。
