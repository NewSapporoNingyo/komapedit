...
Stop and request a human decision before silently choosing a new file-format strategy, compatibility break, public ABI migration, dependency, framework, or other architecture change not determined by the task.
