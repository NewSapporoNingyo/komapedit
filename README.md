...
| `Curve.BeginTransition()`                                                                                                                                                                   |    √    |       △       |      △      |         ✕         | The wizard creates it only atomically before a two-argument `Curve.Begin` or selected `Curve.End`; no standalone transition template                                        |
| `Curve.Begin(radius, cant)` / `[legacy] Curve.BeginCircular(radius, cant)`                                                                                                                  |    √    |       √       |      △      |         ✕         | The wizard emits current `Curve.Begin(radius, cant)` only atomically with a preceding transition; `Curve.BeginCircular` remains edit-only                                   |
| `Curve.Begin(radius)` / `Curve.Change(radius)`                                                                                                                                              |    √    |       √       |      √      |         ✕         | The wizard inserts the current one-argument Begin and Change forms; existing rows remain editable and deletable without method conversion                                   |
| `Curve.End()`                                                                                                                                                                               |    √    |       √       |      √      |         ✕         | The wizard inserts End, optionally atomically with its transition start; existing rows remain editable and deletable                                                         |
...
| `Gradient.BeginTransition()`                                                                                                                                                                |    √    |       △       |      △      |         ✕         | The wizard creates it only atomically before a selected `Gradient.Begin` or `Gradient.End`; no standalone transition template                                               |
| `Gradient.Begin(gradient)` / `[legacy] Gradient.BeginConst(gradient)`                                                                                                                       |    √    |       √       |      √      |         ✕         | The wizard emits current `Gradient.Begin(gradient)`, optionally atomically with a preceding transition; `Gradient.BeginConst` remains edit-only                            |
| `Gradient.End()`                                                                                                                                                                            |    √    |       √       |      √      |         ✕         | The wizard inserts End, optionally atomically with its transition start; existing rows remain editable and deletable                                                         |
