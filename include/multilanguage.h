...
struct Translation {
    ...
    Translation() {
        en = {
            ...
            {"menu.view_3d", "3D View"}, {"menu.structure_model_preview", "Structure Model Preview"}, {"menu.scene_preview", "3D Scene Preview"}, {"menu.preview_model", "Preview Model"}, {"menu.find_in_structure_models", "Find in Structure Model List"}, {"menu.find_in_signal_aspects", "Find in Signal Aspect List"}, {"menu.find_in_sound_files", "Find in Sound File List"}, {"menu.find_in_sound_3d_files", "Find in 3D Sound File List"},
        ...
        zh = {
            ...
            {"menu.view_3d", "3D视图"}, {"menu.structure_model_preview", "布景模型预览"}, {"menu.scene_preview", "3D场景预览"}, {"menu.preview_model", "预览模型"}, {"menu.find_in_structure_models", "在布景模型列表中查找"}, {"menu.find_in_signal_aspects", "在信号现示列表中查找"}, {"menu.find_in_sound_files", "在音效文件列表中查找"}, {"menu.find_in_sound_3d_files", "在3D音效文件列表中查找"},
        ...
        ja = {
            ...
            {"menu.view_3d", "3Dビュー"}, {"menu.structure_model_preview", "ストラクチャーモデルプレビュー"}, {"menu.scene_preview", "3Dシーンプレビュー"}, {"menu.preview_model", "モデルをプレビュー"}, {"menu.find_in_structure_models", "ストラクチャーモデルリストで検索"}, {"menu.find_in_signal_aspects", "信号現示リストで検索"}, {"menu.find_in_sound_files", "サウンドファイルリストで検索"}, {"menu.find_in_sound_3d_files", "3Dサウンドファイルリストで検索"},
