...
struct Translation {
    ...
    Translation() {
        en = {
            ...
            {"menu.controlpoints", "Control Points..."}, {"menu.plotlimit", "Plot Range..."}, {"menu.ui_settings", "UI Settings..."}, {"menu.font_size", "UI Settings..."}, {"menu.canvas_2d_settings", "2D Canvas Settings"}, {"menu.canvas_element_sizes", "Canvas Element Sizes"}, {"menu.about", "About"},
            ...
            {"dialog.ui_settings", "UI Settings"}, {"dialog.canvas_element_sizes", "Canvas Element Sizes"}, {"dialog.bgimage_adjust", "Adjust Background Image"}, {"dialog.align_to_station", "Align Background to Stations"}, {"button.pick_on_bg", "Pick station on Plan"}, {"button.pick_on_bg_ok", "Picked"},
        ...
        zh = {
            ...
            {"menu.controlpoints", "控制点间隔..."}, {"menu.plotlimit", "绘图范围..."}, {"menu.ui_settings", "用户界面设置..."}, {"menu.font_size", "用户界面设置..."}, {"menu.canvas_2d_settings", "2D画布设置"}, {"menu.canvas_element_sizes", "画布元素尺寸"}, {"menu.about", "关于"},
            ...
            {"dialog.ui_settings", "用户界面设置"}, {"dialog.canvas_element_sizes", "画布元素尺寸"}, {"dialog.bgimage_adjust", "调整背景图"}, {"dialog.align_to_station", "按车站对齐背景图"}, {"button.pick_on_bg", "在平面图选点"}, {"button.pick_on_bg_ok", "已选点"},
        ...
        ja = {
            ...
            {"menu.controlpoints", "制御点間隔..."}, {"menu.plotlimit", "描画範囲..."}, {"menu.ui_settings", "UI設定..."}, {"menu.font_size", "UI設定..."}, {"menu.canvas_2d_settings", "2Dキャンバス設定"}, {"menu.canvas_element_sizes", "キャンバス要素サイズ"}, {"menu.about", "このアプリについて"},
            ...
            {"dialog.ui_settings", "UI設定"}, {"dialog.canvas_element_sizes", "キャンバス要素サイズ"}, {"dialog.bgimage_adjust", "背景画像の調整"}, {"dialog.align_to_station", "背景画像を駅に合わせる"}, {"button.pick_on_bg", "平面図で駅を選択"}, {"button.pick_on_bg_ok", "選択済み"},
