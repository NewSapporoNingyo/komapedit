...
struct Translation {
    ...
    Translation() {
        en = {
            ...
            {"frame.controls", "Controls"}, {"frame.console", "Console"}, {"frame.plots", "2D View"}, {"frame.othertracks", "Other Tracks"},
            {"frame.structures", "Map Structure List"}, {"frame.repeaters", "Repeater List"}, {"frame.aux_info", "Auxiliary Info"},
        ...
        zh = {
            ...
            {"frame.controls", "控制"}, {"frame.console", "控制台"}, {"frame.plots", "2D视图"}, {"frame.othertracks", "其他轨道"},
            {"frame.structures", "地图布景列表"}, {"frame.repeaters", "连续布景列表"}, {"frame.aux_info", "辅助信息"},
        ...
        ja = {
            ...
            {"frame.controls", "コントロール"}, {"frame.console", "コンソール"}, {"frame.plots", "2Dビュー"}, {"frame.othertracks", "他軌道"},
            {"frame.structures", "ストラクチャー一覧"}, {"frame.repeaters", "連続ストラクチャー一覧"}, {"frame.aux_info", "補助情報"},
