...
struct Translation {
    ...
    Translation() {
        en = {
            ...
            {"menu.online_docs", "Online Documentation"}, {"menu.open_in_explorer", "Open in File Explorer"}, {"menu.locate_on_plan", "Locate on Plan"}, {"menu.locate_in_structure_list", "Locate in Map Structure List"}, {"menu.locate_in_repeater_list", "Locate in Repeater List"},
        ...
        zh = {
            ...
            {"menu.online_docs", "在线文档"}, {"menu.open_in_explorer", "在文件资源管理器中打开"}, {"menu.locate_on_plan", "定位至平面图"}, {"menu.locate_in_structure_list", "定位至地图布景列表"}, {"menu.locate_in_repeater_list", "定位至连续布景列表"},
        ...
        ja = {
            ...
            {"menu.online_docs", "オンラインドキュメント"}, {"menu.open_in_explorer", "エクスプローラーで開く"}, {"menu.locate_on_plan", "平面図へ移動"}, {"menu.locate_in_structure_list", "ストラクチャーリストへ移動"}, {"menu.locate_in_repeater_list", "連続ストラクチャーリストへ移動"},
            ...
            {"frame.structures", "ストラクチャーリスト"}, {"frame.structure_models", "ストラクチャーモデルリスト"}, {"frame.repeaters", "連続ストラクチャーリスト"}, {"frame.aux_info", "補助情報"}, {"frame.model_preview", "3D-モデルプレビュー"},
