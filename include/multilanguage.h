...
struct Translation {
    ...
    Translation() {
        en = {
            ...
            {"menu.map_info.structures", "Map Structure"}, {"menu.map_info.structure_models", "Structure Model"}, {"menu.map_info.sound_files", "Sound File"}, {"menu.map_info.sound_3d_files", "3D Sound File"}, {"menu.map_info.map_sounds", "Map Sound"},
        ...
        zh = {
            ...
            {"menu.map_info.structures", "地图布景"}, {"menu.map_info.structure_models", "布景模型"}, {"menu.map_info.sound_files", "音效文件"}, {"menu.map_info.sound_3d_files", "3D音效文件"}, {"menu.map_info.map_sounds", "地图音效"},
        ...
        ja = {
            ...
            {"menu.map_info.structures", "マップストラクチャー"}, {"menu.map_info.structure_models", "ストラクチャーモデル"}, {"menu.map_info.sound_files", "サウンドファイル"}, {"menu.map_info.sound_3d_files", "3Dサウンドファイル"}, {"menu.map_info.map_sounds", "マップサウンド"},
