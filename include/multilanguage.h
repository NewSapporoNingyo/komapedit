...
struct Translation {
    ...
    Translation() {
        en = {
            ...
            {"mode.pan", "Move"}, {"mode.select", "Select"}, {"mode.measure", "Measure"}, {"label.station_jump", "Station Jump"},
        ...
        zh = {
            ...
            {"mode.pan", "移动"}, {"mode.select", "选择"}, {"mode.measure", "测量"}, {"label.station_jump", "车站跳转"},
        ...
        ja = {
            ...
            {"mode.pan", "移動"}, {"mode.select", "選択"}, {"mode.measure", "測定"}, {"label.station_jump", "駅ジャンプ"},
