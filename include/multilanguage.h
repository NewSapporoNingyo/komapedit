...
struct Translation {
    ...
    Translation() {
        en = {
            ...
            {"chk.view_2d_window", "2D View Window"}, {"chk.structure_pos", "Structure Positions"}, {"chk.repeater_pos", "Repeater Positions"},
        ...
        zh = {
            ...
            {"chk.view_2d_window", "2D视图窗口"}, {"chk.structure_pos", "布景位置"}, {"chk.repeater_pos", "连续布景位置"},
        ...
        ja = {
            ...
            {"chk.view_2d_window", "2Dビューウィンドウ"}, {"chk.structure_pos", "ストラクチャ位置"}, {"chk.repeater_pos", "連続ストラクチャ位置"},
