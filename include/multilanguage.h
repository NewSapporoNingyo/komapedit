...
struct Translation {
    ...
    Translation() {
        en = {
            ...
            {"menu.online_docs", "Online Documentation"}, {"menu.open_in_explorer", "Open in File Explorer"}, {"menu.locate_on_plan", "Locate on Plan"},
            {"menu.view_3d", "3D View"}, {"menu.structure_model_preview", "Structure Model Preview"}, {"menu.preview_model", "Preview Model"},
            ...
            {"button.model_list", "Model List"}, {"button.background_color", "Background Color"},
        ...
        zh = {
            ...
            {"menu.online_docs", "在线文档"}, {"menu.open_in_explorer", "在文件资源管理器中打开"}, {"menu.locate_on_plan", "定位至平面图"},
            {"menu.view_3d", "3D视图"}, {"menu.structure_model_preview", "布景模型预览"}, {"menu.preview_model", "预览模型"},
            ...
            {"button.model_list", "模型列表"}, {"button.background_color", "背景颜色"},
        ...
        ja = {
            ...
            {"menu.online_docs", "オンラインドキュメント"}, {"menu.open_in_explorer", "エクスプローラーで開く"}, {"menu.locate_on_plan", "平面図へ移動"},
            {"menu.view_3d", "3Dビュー"}, {"menu.structure_model_preview", "ストラクチャーモデルプレビュー"}, {"menu.preview_model", "モデルをプレビュー"},
            ...
            {"button.model_list", "モデル一覧"}, {"button.background_color", "背景色"},
