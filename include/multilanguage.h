...
struct Translation {
    ...
    Translation() {
        en = {
            ...
            {"menu.view_3d", "3D View"}, {"menu.structure_model_preview", "Structure Model Preview"}, {"menu.preview_model", "Preview Model"}, {"menu.find_in_structure_models", "Find in Structure Model List"}, {"menu.find_in_sound_files", "Find in Sound File List"}, {"menu.find_in_sound_3d_files", "Find in 3D Sound File List"},
            ...
            {"button.model_list", "Model List"}, {"button.background_color", "Background Color"}, {"button.find", "Find"}, {"button.find_unused_structure_models", "Search unused structure models"}, {"button.find_unused_sound_files", "Search unused sounds"}, {"button.find_unused_sound_3d_files", "Search unused 3D sounds"},
        ...
        zh = {
            ...
            {"menu.view_3d", "3D视图"}, {"menu.structure_model_preview", "布景模型预览"}, {"menu.preview_model", "预览模型"}, {"menu.find_in_structure_models", "在布景模型列表中查找"}, {"menu.find_in_sound_files", "在音效文件列表中查找"}, {"menu.find_in_sound_3d_files", "在3D音效文件列表中查找"},
            ...
            {"button.model_list", "模型列表"}, {"button.background_color", "背景颜色"}, {"button.find", "查找"}, {"button.find_unused_structure_models", "查找未使用布景模型"}, {"button.find_unused_sound_files", "查找未使用音效"}, {"button.find_unused_sound_3d_files", "查找未使用3D音效"},
        ...
        ja = {
            ...
            {"menu.view_3d", "3Dビュー"}, {"menu.structure_model_preview", "ストラクチャーモデルプレビュー"}, {"menu.preview_model", "モデルをプレビュー"}, {"menu.find_in_structure_models", "ストラクチャーモデルリストで検索"}, {"menu.find_in_sound_files", "サウンドファイルリストで検索"}, {"menu.find_in_sound_3d_files", "3Dサウンドファイルリストで検索"},
            ...
            {"button.model_list", "モデルリスト"}, {"button.background_color", "背景色"}, {"button.find", "検索"}, {"button.find_unused_structure_models", "未使用モデルを検索"}, {"button.find_unused_sound_files", "未使用サウンドを検索"}, {"button.find_unused_sound_3d_files", "未使用3Dサウンドを検索"},
