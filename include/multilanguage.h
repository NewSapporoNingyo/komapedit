...
struct Translation {
    ...
    Translation() {
        ...
        zh = {
            ...
            {"frame.structures", "地图布景列表"}, {"frame.structure_models", "布景模型列表"}, {"frame.sound_list", "音效列表"}, {"frame.sound_3d_list", "3D音效列表"}, {"frame.repeaters", "连续布景列表"}, {"frame.irregularities", "轨道变位列表"}, {"frame.adhesions", "粘着特性变化点列表"}, {"frame.cab_illuminance", "驾驶台亮度变化点列表"}, {"frame.fogs", "雾效果变化点列表"}, {"frame.aux_info", "辅助信息"}, {"frame.model_preview", "3D-模型预览"},
