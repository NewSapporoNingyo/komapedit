...
struct Translation {
    ...
    Translation() {
        en = {
            ...
            {"dialog.ui_settings", "UI Settings"}, {"dialog.canvas_element_sizes", "Canvas Element Sizes"}, {"dialog.canvas_3d_settings", "3D Canvas Settings"}, {"dialog.element_properties", "Properties/Edit"}, {"dialog.reload_unsaved_title", "Reload from Disk"}, {"dialog.reload_unsaved_message", "There are unsaved changes. Reload from disk?"}, {"dialog.bgimage_adjust", "Adjust Background Image"}, {"dialog.align_to_station", "Align Background to Stations"}, {"button.pick_on_bg", "Pick station on Plan"}, {"button.pick_on_bg_ok", "Picked"},
        ...
        zh = {
            ...
            {"dialog.ui_settings", "用户界面设置"}, {"dialog.canvas_element_sizes", "画布元素尺寸"}, {"dialog.canvas_3d_settings", "3D画布设置"}, {"dialog.element_properties", "属性/编辑"}, {"dialog.reload_unsaved_title", "重新加载"}, {"dialog.reload_unsaved_message", "有未保存的更改，确认是否重新加载？"}, {"dialog.bgimage_adjust", "调整背景图"}, {"dialog.align_to_station", "按车站对齐背景图"}, {"button.pick_on_bg", "在平面图选点"}, {"button.pick_on_bg_ok", "已选点"},
