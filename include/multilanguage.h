...
struct Translation {
    ...
    Translation() {
        en = {
            ...
            {"chk.prof_othert", "Other Tracks (Profile)"}, {"chk.speedlimit", "Speed Limit"}, {"chk.irregularity_markers", "Track Irregularity Change Points"}, {"chk.adhesion_markers", "Adhesion Change Points"}, {"chk.cab_illuminance_markers", "Cab Illuminance Change Points"},
        ...
        zh = {
            ...
            {"frame.structures", "地图布景列表"}, {"frame.structure_models", "布景模型列表"}, {"frame.repeaters", "连续布景列表"}, {"frame.irregularities", "轨道变位列表"}, {"frame.adhesions", "粘着特性变化点列表"}, {"frame.cab_illuminance", "驾驶台亮度变化点列表"}, {"frame.aux_info", "辅助信息"}, {"frame.model_preview", "3D-模型预览"},
            ...
            {"chk.prof_othert", "纵断面其他轨道"}, {"chk.speedlimit", "限速"}, {"chk.irregularity_markers", "轨道变位变化点"}, {"chk.adhesion_markers", "粘着特性变化点"}, {"chk.cab_illuminance_markers", "驾驶台亮度变化点"},
        ...
        ja = {
            ...
            {"frame.structures", "ストラクチャーリスト"}, {"frame.structure_models", "ストラクチャーモデルリスト"}, {"frame.repeaters", "連続ストラクチャーリスト"}, {"frame.irregularities", "軌道変位リスト"}, {"frame.adhesions", "粘着特性変化点リスト"}, {"frame.cab_illuminance", "運転台明るさ変化点リスト"}, {"frame.aux_info", "補助情報"}, {"frame.model_preview", "3D-モデルプレビュー"},
            ...
            {"chk.prof_othert", "縦断面の他軌道"}, {"chk.speedlimit", "速度制限"}, {"chk.irregularity_markers", "軌道変位変化点"}, {"chk.adhesion_markers", "粘着特性変化点"}, {"chk.cab_illuminance_markers", "運転台明るさ変化点"},
