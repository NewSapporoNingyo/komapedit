...
struct Translation {
    ...
    Translation() {
        en = {
            ...
            {"menu.online_docs", "Online Documentation"}, {"menu.report_bugs", "Report Bugs"}, {"menu.open_in_explorer", "Open in File Explorer"}, {"menu.locate_on_plan", "Locate on Plan"}, {"menu.locate_in_structure_list", "Locate in Map Structure List"}, {"menu.locate_in_repeater_list", "Locate in Repeater List"}, {"menu.locate_in_signal_list", "Locate in Map Signal List"}, {"menu.locate_in_beacon_list", "Locate in Beacon List"}, {"menu.locate_in_irregularity_list", "Locate in Track Irregularity List"}, {"menu.locate_in_adhesion_list", "Locate in Adhesion Change Point List"}, {"menu.locate_in_cab_illuminance_list", "Locate in Cab Illuminance Change Point List"}, {"menu.locate_in_fog_list", "Locate in Fog Change Point List"},
            {"menu.view_3d", "3D View"}, {"menu.structure_model_preview", "Structure Model Preview"}, {"menu.scene_preview", "3D Scene Preview"}, {"menu.preview_model", "Preview Model"}, {"menu.find_in_structure_models", "Find in Structure Model List"}, {"menu.find_in_sound_files", "Find in Sound File List"}, {"menu.find_in_sound_3d_files", "Find in 3D Sound File List"},
            ...
            {"button.apply", "Apply"}, {"button.reset", "Reset"}, {"button.ok", "OK"}, {"button.cancel", "Cancel"}, {"button.clear", "Clear"}, {"button.close", "Close"},
            {"button.model_list", "Model List"}, {"button.start_scene_preview", "Start 3D Scene Preview"}, {"button.background_color", "Background Color"}, {"button.find", "Find"}, {"button.find_unused_structure_models", "Search unused structure models"}, {"button.find_unused_sound_files", "Search unused sounds"}, {"button.find_unused_sound_3d_files", "Search unused 3D sounds"},
            ...
            {"chk.prof_othert", "Other Tracks (Profile)"}, {"chk.speedlimit", "Speed Limit"}, {"chk.irregularity_markers", "Track Irregularity Change Points"}, {"chk.beacon_markers", "Beacon Positions"}, {"chk.pretrain_markers", "PreTrain Pass Points"}, {"chk.adhesion_markers", "Adhesion Change Points"}, {"chk.cab_illuminance_markers", "Cab Illuminance Change Points"}, {"chk.fog_markers", "Fog Change Points"}, {"chk.scene_owntrack_markers", "Own Track Markers"}, {"chk.scene_current_position_on_plan", "Show Current Position on Plan"},
            ...
            {"status.find.no_match", "No matching text found"}, {"status.find.match", "Found ({current}/{total})"}, {"status.unused_structure_models.match", "Found unused models ({unused}/{total})"}, {"status.unused_structure_models.no_match", "No unused models found"}, {"status.unused_sound_files.match", "Found unused sounds ({unused}/{total})"}, {"status.unused_sound_files.no_match", "No unused sounds found"}, {"status.unused_sound_3d_files.match", "Found unused 3D sounds ({unused}/{total})"}, {"status.unused_sound_3d_files.no_match", "No unused 3D sounds found"},
        ...
        zh = {
            ...
            {"menu.online_docs", "在线文档"}, {"menu.report_bugs", "报告问题"}, {"menu.open_in_explorer", "在文件资源管理器中打开"}, {"menu.locate_on_plan", "定位至平面图"}, {"menu.locate_in_structure_list", "定位至地图布景列表"}, {"menu.locate_in_repeater_list", "定位至连续布景列表"}, {"menu.locate_in_signal_list", "定位至地图信号列表"}, {"menu.locate_in_beacon_list", "定位至应答器列表"}, {"menu.locate_in_irregularity_list", "定位至轨道变位列表"}, {"menu.locate_in_adhesion_list", "定位至粘着特性变化点列表"}, {"menu.locate_in_cab_illuminance_list", "定位至驾驶台亮度变化点列表"}, {"menu.locate_in_fog_list", "定位至雾效果变化点列表"},
            {"menu.view_3d", "3D视图"}, {"menu.structure_model_preview", "布景模型预览"}, {"menu.scene_preview", "3D场景预览"}, {"menu.preview_model", "预览模型"}, {"menu.find_in_structure_models", "在布景模型列表中查找"}, {"menu.find_in_sound_files", "在音效文件列表中查找"}, {"menu.find_in_sound_3d_files", "在3D音效文件列表中查找"},
            {"button.open", "打开"}, {"button.reload", "重新加载"}, {"button.export_csv", "导出 CSV"},
            {"button.structure_list", "地图布景列表"}, {"button.repeater_list", "连续布景列表"},
            {"button.apply", "应用"}, {"button.reset", "重置"}, {"button.ok", "确定"}, {"button.cancel", "取消"}, {"button.clear", "清除"}, {"button.close", "关闭"},
            {"button.model_list", "模型列表"}, {"button.start_scene_preview", "启动3D场景预览"}, {"button.background_color", "背景颜色"}, {"button.find", "查找"}, {"button.find_unused_structure_models", "查找未使用布景模型"}, {"button.find_unused_sound_files", "查找未使用音效"}, {"button.find_unused_sound_3d_files", "查找未使用3D音效"},
            ...
            {"frame.structures", "地图布景列表"}, {"frame.structure_models", "布景模型列表"}, {"frame.sound_list", "音效文件列表"}, {"frame.sound_3d_list", "3D音效文件列表"}, {"frame.repeaters", "连续布景列表"}, {"frame.signal_aspects", "信号现示列表"}, {"frame.signals", "地图信号列表"}, {"frame.beacons", "应答器列表"}, {"frame.irregularities", "轨道变位列表"}, {"frame.adhesions", "粘着特性变化点列表"}, {"frame.cab_illuminance", "驾驶台亮度变化点列表"}, {"frame.fogs", "雾效果变化点列表"}, {"frame.aux_info", "辅助信息"}, {"frame.model_preview", "3D-模型预览"}, {"frame.scene_preview", "3D-场景预览"},
            {"frame.chart_visibility", "图表显示"}, {"frame.grid", "网格"}, {"frame.mode", "模式"}, {"frame.bgimage", "背景图"},
            {"aux.station", "车站"}, {"aux.track_geometry", "轨道几何"}, {"aux.signal", "信号"}, {"aux.sound", "音效"}, {"aux.effects", "效果"}, {"aux.scene_3d", "3D场景"},
            ...
            {"chk.prof_othert", "纵断面其他轨道"}, {"chk.speedlimit", "限速"}, {"chk.irregularity_markers", "轨道变位变化点"}, {"chk.beacon_markers", "应答器位置"}, {"chk.pretrain_markers", "先行列车通过点"}, {"chk.adhesion_markers", "粘着特性变化点"}, {"chk.cab_illuminance_markers", "驾驶台亮度变化点"}, {"chk.fog_markers", "雾效果变化点"}, {"chk.scene_owntrack_markers", "自轨道标记"}, {"chk.scene_current_position_on_plan", "平面图上显示当前位置"},
            ...
            {"status.find.no_match", "未找到匹配的字符"}, {"status.find.match", "查找到（{current}/{total}）"}, {"status.unused_structure_models.match", "找到未使用模型（{unused}/{total}）"}, {"status.unused_structure_models.no_match", "没有找到未使用模型"}, {"status.unused_sound_files.match", "找到未使用音效（{unused}/{total}）"}, {"status.unused_sound_files.no_match", "没有找到未使用音效"}, {"status.unused_sound_3d_files.match", "找到未使用3D音效（{unused}/{total}）"}, {"status.unused_sound_3d_files.no_match", "没有找到未使用3D音效"},
        ...
        ja = {
            ...
            {"menu.online_docs", "オンラインドキュメント"}, {"menu.report_bugs", "不具合を報告"}, {"menu.open_in_explorer", "エクスプローラーで開く"}, {"menu.locate_on_plan", "平面図へ移動"}, {"menu.locate_in_structure_list", "ストラクチャーリストへ移動"}, {"menu.locate_in_repeater_list", "連続ストラクチャーリストへ移動"}, {"menu.locate_in_signal_list", "マップ信号リストへ移動"}, {"menu.locate_in_beacon_list", "地上子リストへ移動"}, {"menu.locate_in_irregularity_list", "軌道変位リストへ移動"}, {"menu.locate_in_adhesion_list", "粘着特性変化点リストへ移動"}, {"menu.locate_in_cab_illuminance_list", "運転台明るさ変化点リストへ移動"}, {"menu.locate_in_fog_list", "霧効果変化点リストへ移動"},
            {"menu.view_3d", "3Dビュー"}, {"menu.structure_model_preview", "ストラクチャーモデルプレビュー"}, {"menu.scene_preview", "3Dシーンプレビュー"}, {"menu.preview_model", "モデルをプレビュー"}, {"menu.find_in_structure_models", "ストラクチャーモデルリストで検索"}, {"menu.find_in_sound_files", "サウンドファイルリストで検索"}, {"menu.find_in_sound_3d_files", "3Dサウンドファイルリストで検索"},
            ...
            {"button.apply", "適用"}, {"button.reset", "リセット"}, {"button.ok", "OK"}, {"button.cancel", "キャンセル"}, {"button.clear", "クリア"}, {"button.close", "閉じる"},
            {"button.model_list", "モデルリスト"}, {"button.start_scene_preview", "3Dシーンプレビューを開始"}, {"button.background_color", "背景色"}, {"button.find", "検索"}, {"button.find_unused_structure_models", "未使用モデルを検索"}, {"button.find_unused_sound_files", "未使用サウンドを検索"}, {"button.find_unused_sound_3d_files", "未使用3Dサウンドを検索"},
            ...
            {"frame.structures", "ストラクチャーリスト"}, {"frame.structure_models", "ストラクチャーモデルリスト"}, {"frame.sound_list", "サウンドファイルリスト"}, {"frame.sound_3d_list", "3Dサウンドファイルリスト"}, {"frame.repeaters", "連続ストラクチャーリスト"}, {"frame.signal_aspects", "信号現示リスト"}, {"frame.signals", "マップ信号リスト"}, {"frame.beacons", "地上子リスト"}, {"frame.irregularities", "軌道変位リスト"}, {"frame.adhesions", "粘着特性変化点リスト"}, {"frame.cab_illuminance", "運転台明るさ変化点リスト"}, {"frame.fogs", "霧効果変化点リスト"}, {"frame.aux_info", "補助情報"}, {"frame.model_preview", "3D-モデルプレビュー"}, {"frame.scene_preview", "3D-シーンプレビュー"},
            {"frame.chart_visibility", "チャート表示"}, {"frame.grid", "グリッド"}, {"frame.mode", "モード"}, {"frame.bgimage", "背景画像"},
            {"aux.station", "駅"}, {"aux.track_geometry", "軌道幾何"}, {"aux.signal", "信号"}, {"aux.sound", "サウンド"}, {"aux.effects", "効果"}, {"aux.scene_3d", "3Dシーン"},
            ...
            {"chk.prof_othert", "縦断面の他軌道"}, {"chk.speedlimit", "速度制限"}, {"chk.irregularity_markers", "軌道変位変化点"}, {"chk.beacon_markers", "地上子位置"}, {"chk.pretrain_markers", "先行列車通過点"}, {"chk.adhesion_markers", "粘着特性変化点"}, {"chk.cab_illuminance_markers", "運転台明るさ変化点"}, {"chk.fog_markers", "霧効果変化点"}, {"chk.scene_owntrack_markers", "自軌道マーカー"}, {"chk.scene_current_position_on_plan", "平面図に現在位置を表示"},
            ...
            {"status.find.no_match", "一致する文字が見つかりません"}, {"status.find.match", "検索結果（{current}/{total}）"}, {"status.unused_structure_models.match", "未使用モデルを検出（{unused}/{total}）"}, {"status.unused_structure_models.no_match", "未使用モデルは見つかりません"}, {"status.unused_sound_files.match", "未使用サウンドを検出（{unused}/{total}）"}, {"status.unused_sound_files.no_match", "未使用サウンドは見つかりません"}, {"status.unused_sound_3d_files.match", "未使用3Dサウンドを検出（{unused}/{total}）"}, {"status.unused_sound_3d_files.no_match", "未使用3Dサウンドは見つかりません"},
