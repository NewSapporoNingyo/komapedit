...
struct Translation {
    ...
    Translation() {
        en = {
            ...
            {"label.font_size", "Text size"}, {"label.ui_component_size", "UI component size"}, {"label.station_marker_size", "Marker size"}, {"label.scene_draw_distance", "Draw distance"}, {"label.ui_theme_color", "Interface theme color"},
        ...
        zh = {
            ...
            {"label.font_size", "文字大小"}, {"label.ui_component_size", "界面组件大小"}, {"label.station_marker_size", "标记尺寸"}, {"label.scene_draw_distance", "绘制距离"}, {"label.ui_theme_color", "界面主题色"},
        ...
        ja = {
            ...
            {"label.font_size", "文字サイズ"}, {"label.ui_component_size", "UI部品サイズ"}, {"label.station_marker_size", "マーカーサイズ"}, {"label.scene_draw_distance", "描画距離"}, {"label.ui_theme_color", "UIテーマカラー"},
