...
struct Translation {
    ...
    Translation() {
        en = {
            ...
            {"frame.joint_noises", "Joint Noise Change Point List"},
            {"chk.joint_noise_markers", "Joint Noise Change Points"},
            {"menu.locate_in_joint_noise_list", "Locate in Joint Noise Change Point List"},
        ...
        zh = {
            ...
            {"frame.joint_noises", "道岔音效变化点列表"},
            {"chk.joint_noise_markers", "道岔音效变化点"},
            {"menu.locate_in_joint_noise_list", "定位至道岔音效变化点列表"},
        ...
        ja = {
            ...
            {"frame.joint_noises", "分岐器通過音変化点リスト"},
            {"chk.joint_noise_markers", "分岐器通過音変化点"},
            {"menu.locate_in_joint_noise_list", "分岐器通過音変化点リストへ移動"},
