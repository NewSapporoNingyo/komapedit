...
struct Translation {
    ...
    Translation() {
        en = {
            ...
            {"frame.structures", "Map Structure List"}, {"frame.structure_models", "Structure Model List"}, {"frame.repeaters", "Repeater List"}, {"frame.irregularities", "Track Irregularity List"}, {"frame.adhesions", "Adhesion Change Point List"}, {"frame.aux_info", "Auxiliary Info"}, {"frame.model_preview", "3D-Model Preview"},
            ...
            {"chk.prof_othert", "Other Tracks (Profile)"}, {"chk.speedlimit", "Speed Limit"}, {"chk.irregularity_markers", "Track Irregularity Change Points"}, {"chk.adhesion_markers", "Adhesion Change Points"},
        ...
        zh = {
            ...
            {"menu.online_docs", "在线文档"}, {"menu.open_in_explorer", "在文件资源管理器中打开"}, {"menu.locate_on_plan", "定位至平面图"}, {"menu.locate_in_structure_list", "定位至地图布景列表"}, {"menu.locate_in_repeater_list", "定位至连续布景列表"}, {"menu.locate_in_irregularity_list", "定位至轨道变位列表"}, {"menu.locate_in_adhesion_list", "定位至粘着特性变化点列表"},
            ...
            {"frame.structures", "地图布景列表"}, {"frame.structure_models", "布景模型列表"}, {"frame.repeaters", "连续布景列表"}, {"frame.irregularities", "轨道变位列表"}, {"frame.adhesions", "粘着特性变化点列表"}, {"frame.aux_info", "辅助信息"}, {"frame.model_preview", "3D-模型预览"},
            ...
            {"chk.prof_othert", "纵断面其他轨道"}, {"chk.speedlimit", "限速"}, {"chk.irregularity_markers", "轨道变位变化点"}, {"chk.adhesion_markers", "粘着特性变化点"},
        ...
        ja = {
            ...
            {"menu.online_docs", "オンラインドキュメント"}, {"menu.open_in_explorer", "エクスプローラーで開く"}, {"menu.locate_on_plan", "平面図へ移動"}, {"menu.locate_in_structure_list", "ストラクチャーリストへ移動"}, {"menu.locate_in_repeater_list", "連続ストラクチャーリストへ移動"}, {"menu.locate_in_irregularity_list", "軌道変位リストへ移動"}, {"menu.locate_in_adhesion_list", "粘着特性変化点リストへ移動"},
            ...
            {"frame.structures", "ストラクチャーリスト"}, {"frame.structure_models", "ストラクチャーモデルリスト"}, {"frame.repeaters", "連続ストラクチャーリスト"}, {"frame.irregularities", "軌道変位リスト"}, {"frame.adhesions", "粘着特性変化点リスト"}, {"frame.aux_info", "補助情報"}, {"frame.model_preview", "3D-モデルプレビュー"},
            ...
            {"chk.prof_othert", "縦断面の他軌道"}, {"chk.speedlimit", "速度制限"}, {"chk.irregularity_markers", "軌道変位変化点"}, {"chk.adhesion_markers", "粘着特性変化点"},
