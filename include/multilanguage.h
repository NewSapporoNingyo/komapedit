...
struct Translation {
    ...
    Translation() {
        en = {
            ...
            {"aux.station", "Station"}, {"aux.track_geometry", "Track Geometry"}, {"aux.signal", "Signal"}, {"aux.sound", "Sound"}, {"aux.effects", "Effects"},
        ...
        zh = {
            ...
            {"aux.station", "车站"}, {"aux.track_geometry", "轨道几何"}, {"aux.signal", "信号"}, {"aux.sound", "音效"}, {"aux.effects", "效果"},
            ...
            {"chk.prof_othert", "纵断面其他轨道"}, {"chk.speedlimit", "限速"}, {"chk.irregularity_markers", "轨道变位变化点"}, {"chk.beacon_markers", "应答器位置"}, {"chk.pretrain_markers", "先行列车通过点"}, {"chk.adhesion_markers", "粘着特性变化点"}, {"chk.cab_illuminance_markers", "驾驶台亮度变化点"}, {"chk.fog_markers", "雾效果变化点"},
        ...
        ja = {
            ...
            {"aux.station", "駅"}, {"aux.track_geometry", "軌道幾何"}, {"aux.signal", "信号"}, {"aux.sound", "サウンド"}, {"aux.effects", "効果"},
            ...
            {"chk.prof_othert", "縦断面の他軌道"}, {"chk.speedlimit", "速度制限"}, {"chk.irregularity_markers", "軌道変位変化点"}, {"chk.beacon_markers", "地上子位置"}, {"chk.pretrain_markers", "先行列車通過点"}, {"chk.adhesion_markers", "粘着特性変化点"}, {"chk.cab_illuminance_markers", "運転台明るさ変化点"}, {"chk.fog_markers", "霧効果変化点"},
