...
struct Translation {
    ...
    Translation() {
        en = {
            ...
            {"aux.station", "Station"}, {"aux.scenery", "Structures"}, {"aux.track_geometry", "Track Geometry"}, {"aux.signal", "Signal"}, {"aux.sound", "Sound"}, {"aux.effects", "Effects"}, {"aux.scene_3d", "3D Scene"},
        ...
        zh = {
            ...
            {"aux.station", "车站"}, {"aux.scenery", "布景"}, {"aux.track_geometry", "轨道几何"}, {"aux.signal", "信号"}, {"aux.sound", "音效"}, {"aux.effects", "效果"}, {"aux.scene_3d", "3D场景"},
        ...
        ja = {
            ...
            {"aux.station", "駅"}, {"aux.scenery", "ストラクチャー"}, {"aux.track_geometry", "軌道幾何"}, {"aux.signal", "信号"}, {"aux.sound", "サウンド"}, {"aux.effects", "効果"}, {"aux.scene_3d", "3Dシーン"},
